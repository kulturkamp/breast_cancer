...
test_data_sltd = test_data[, selected_features]
train_data_sltd = train_data[, selected_features]
...
model_knn_sl = train(diagnosis~.,
                      train_data_sltd,
                      method="knn",
                      preProc = c("center", "scale"),
                      trControl=fitControl)

pred_knn_sl = predict(model_knn_sl, test_data_sltd)
cm_knn_sl = confusionMatrix(pred_knn_sl, test_data_sltd$diagnosis, positive = "B")
cm_knn_sl
...
model_rf_sl = train(diagnosis~.,
                     train_data_sltd,
                     method="ranger",
                     preProc = c("center", "scale"),
                     trControl=fitControl)
pred_rf_sl = predict(model_rf_sl, test_data_sltd)
cm_rf_sl = confusionMatrix(pred_rf_sl, test_data_sltd$diagnosis, positive = "B")
cm_rf_sl
...
model_nb_sl = train(diagnosis~.,
                     train_data_sltd,
                     method="nb",
                     preProc = c("center", "scale"),
                     trControl=fitControl)

pred_nb_sl = predict(model_nb_sl, test_data_sltd)
cm_nb_sl = confusionMatrix(pred_nb_sl, test_data_sltd$diagnosis, positive = "B")
cm_nb_sl
